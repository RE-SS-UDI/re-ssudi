urlEliminar='/backend/proyecto/eliminar';
...
$(document).ready(function(){
    ...
    var filtro="/backend/proyecto/grid";
    if($("#fdescripcion").val()!="")       filtro+="/descripcion/"+$("#fdescripcion").val();
    if($("#farea").val()!="")       filtro+="/area/"+$("#farea").val();
    if($("#fstatus").val()!="")      filtro+="/status/"+$("#fstatus").val();
        ...
        colModel: [
            ...
            {display: "Area",           name:"ap.area",       width: 400, sortable: true, align: "center"},            
