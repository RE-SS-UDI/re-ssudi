...
?>
    ...
    <input id="Elimianr" name="Elimianr" type="submit" value="Eliminar" class="buscar" onclick="EliminarPregunta(); return false;"/>
		...
		if ($nump >0){
			...
			for($j=0; $j<$nump; $j++){
				...
				echo "<tr>";
					echo "<td>$cod</td>";
					echo "<td>$desc</td>";
					echo "<td><center><a href=\"#\" onclick=\"ImgEliminarPregunta($cod); return false;\"><img src=\"../assets/img/eliminar.png\" border=\"0\" height=20 /></a></center></td>";
				echo "</tr>";
			}
			echo "</table>";
			echo "<br><br>";
