...
?>
        ...
        <form action="EliminarUsuario.php">
            <input type="submit" value="Eliminar otro">
        </FORM>
<?php
        return; //Termina el codigo
    }
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		$sqlActualizar = "UPDATE usuario SET elimina_usuario=1 where idUsuario='".$idModificar."'";
...
Se eliminó el usuario " <?php echo $obj->nombreUsuario->valor;?> " con éxito 
