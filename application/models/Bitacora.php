...
class Bitacora{
		...
		public static function guardar( $modelo, $accion, $referencia){
		$conec = new Conexion;
        $conexion = $conec->abreConexion();

		try{

			$consulta ="INSERT INTO dbo.bitacora";
			$columnas = " (usuario_id,modelo,accion,referencia,created_at,updated_at) ";
			$valores = " values (".Zend_Auth::getInstance()->getIdentity()->id.",'".$modelo."','".$accion."','".$referencia."',GETDATE(),GETDATE());";
			$consulta .= $columnas.$valores;
